...
- **Super Admin**:
  - Master administrative control (default: `superadmin` / `prompt@super2026`).
...
| :--- | :--- | :--- | :--- |
| **Super Admin** | `superadmin` | `prompt@super2026` | Full system control, User Management, Audit Log, 1-Click Rollback, Official Sync |
| **Admin** | `promptweighpack` | `prompt2026` | Catalog CRUD, Edit Specs, Upload Images, Update Site Settings |
| **Guest / Customer** | *None* | *None* | Open public access, search, filter, compare, share links |

> **Security Tip**: Once deployed live, log in as `superadmin`, navigate to **"👥 User Management"**, and change default passwords.
